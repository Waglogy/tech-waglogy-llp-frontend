...
import { ScrollFadeSection, Card3D, FloatingShape } from './Shared'

const HimatoDetail = ({ onBack }) => {
    ...
    return (
        <>
            <SEO title="Himato - AI Personalized Travel" description="Himato by Waglogy - AI-powered travel planning for Sikkim." />

            <div className="relative bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-900 via-[#000] to-[#000] text-slate-100 min-h-screen selection:bg-blue-500 selection:text-white overflow-hidden pb-20">
                ...
                {onBack && (
                    <div className="fixed top-24 left-4 z-50">
                        <button
                            onClick={onBack}
                            className="flex items-center gap-2 text-slate-400 hover:text-white bg-black/50 backdrop-blur-md px-4 py-2 rounded-full border border-white/10 transition-all hover:scale-105"
                        >
                            <span>← Back</span>
                        </button>
                    </div>
                ...
                {/* Hero Section */}
                <section className="relative z-10 pt-40 lg:pt-60 pb-20 px-4 sm:px-6 lg:px-8 min-h-[60vh] flex items-center">
                        ...
                        >
                            ...
                            <div className="mb-12">
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 font-semibold hover:bg-cyan-500/20 hover:scale-105 transition-all"
                                >
                                    Visit Website
