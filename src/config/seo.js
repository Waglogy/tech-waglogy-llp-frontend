// SEO Configuration for Tech Waglogy LLP
// Optimized for Sikkim, India and Northeast India regions
...
export const SITE_CONFIG = {
  ...
  defaultKeywords: [
    ...
    'app development Northeast India',
...
export const PAGE_SEO = {
  ...
  services: {
    ...
    keywords: [
      ...
      'website design services Gangtok',
      'e-commerce development Sikkim',
  ...
  contact: {
    ...
    keywords: [
      'contact Tech Waglogy',
      'web development company Gangtok contact',
      'IT services Sikkim contact',
      'web development consultation Sikkim',
      'app development quote Gangtok'
    ],
    canonical: '/contact'
  },
  ...
  projects: {
    ...
    keywords: [
      'web development portfolio Sikkim',
      'app development projects Gangtok',
      'website portfolio Northeast India',
    ...
    itemListElement: [
      ...
      },
      {
        ...
        itemOffered: {
          '@type': 'Service',
          name: 'AI Solutions',
          description: 'AI-powered chatbots and automation'
        }
      }
    ]
  }
